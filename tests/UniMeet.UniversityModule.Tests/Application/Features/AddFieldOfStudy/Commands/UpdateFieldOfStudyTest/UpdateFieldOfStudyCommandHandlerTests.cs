...
public class UpdateFieldOfStudyCommandHandlerTests
{
    ...
    private readonly UpdateFieldOfStudyCommandHandler _handler;

    public UpdateFieldOfStudyCommandHandlerTests()
    {
        _mockRepository = new Mock<IUniversityRepository>();
        _handler = new UpdateFieldOfStudyCommandHandler(_mockRepository.Object);
    }

    [Fact]
    public async Task Handle_ShouldUpdateFieldOfStudyAndSaveChanges_WhenDataIsProvided()
    {
        // ---- ARRANGE ----
